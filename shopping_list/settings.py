...
import environ #tambahan
import os #tambahan

# Build paths inside the project like this: BASE_DIR / 'subdir'.
BASE_DIR = Path(__file__).resolve().parent.parent
env = environ.Env() #tambahan
...
SECRET_KEY = 'django-insecure-9@*#q^*hjtk^*n)%3a@%-rpitgm*-eqbpz9em26evu%88@-d32'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'], #tambahan
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_ROOT = os.path.join(BASE_DIR, 'static') #tambahan
